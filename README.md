# Lights Out in React
![](https://raw.githubusercontent.com/jeffleu/lights-out/master/src/client/images/demo.gif)
...
## Download
You can either download the [zip file](https://github.com/jeffleu/lights-out/archive/master.zip) or use `git` to clone it down:
```
git clone https://github.com/jeffleu/lights-out.git
cd lights-out
```
